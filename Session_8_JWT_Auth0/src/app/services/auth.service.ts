...
//After the registration at https://auth0.com/, you will be able the get this data.
...
export class AuthService {
  //This is the way how can you create a global, auth0 object to use.
    auth0 = new auth0.WebAuth({
        clientID: AUTH_CONFIG.clientID,
        domain: AUTH_CONFIG.domain,
        responseType: 'token id_token',     //What should we recieved
        redirectUri: 'https://localhost:4200/lessons',  //Where to redirect after success
        scope: 'openid email'
    });
